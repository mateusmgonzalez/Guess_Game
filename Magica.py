...
"""
class SoSimeNão(Exception):
      def __str__(self):
            return "Só sim ou não" 
class Jogo(object):
      def __init__(self):
            self.__cartoes = ('''
            1   3   5   7   9   11  13  15
      ...
      def apresentação(self):
            ...
            funciona o jogo.
            """
            print("Quer participar de uma mágica")
            print("Funciona assim...")
            print("Pensa em um numero e eu vou fazer algumas perguntas e advinhar...")
            print("Vamos lá entao")
      ...
      def recebeEntradaDoUsuário(self):
            ...
            while True:
                  entrada = input("Está nesta cartela? (s/n)  ").upper()
                  try:
      ...
      def imprimeNumeroSecreto(self):
            ...
            """
            print("foi este numero que você pensou %i " %self.__num)
